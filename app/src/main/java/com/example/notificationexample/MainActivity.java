...
import static com.example.notificationexample.MyApp.CHANNEL_1_ID;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void FirstChannel2(View view) {
        String title = editTextTitle.getText().toString();
        String message = getEditTextMessage.getText().toString();

        //on Tap notification it ll open MainActivity
    ...
    public void SecondChannel2(View view) {
        String title = editTextTitle.getText().toString();
        String message = getEditTextMessage.getText().toString();
